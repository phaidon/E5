...
<p><a style="margin:1em 0;" class="z-icon-es-new" href="{modurl modname=E5 type=admin func=modify}">
{gt text="Add module"}
</a></p>
...
{foreach from=$mods item="mod"}
    <tr class="{cycle values="z-odd,z-even"}">
        ...
        <td>
            ...
            <a href="{modurl modname='E5' func='modify' type='admin' id=$mod.modname}">
