<div id="formdialog_content" style="display: none;">
    <form enctype="application/x-www-form-urlencoded" method="post" class="z-form">
        <div>
                <fieldset>
                    <div class="z-formrow">
                        <label for="rows">{gt text="Rows"}</label>
                        <input type="text" value="3" size="50" name="rows" id="rows">
                    </div>
                    <div class="z-formrow">
                        <label for="cols">{gt text="Cols"}</label>
                        <input type="text" value="3" size="50" name="cols" id="cols">
                    </div>
                </fieldset>
            </div>
    </form>
